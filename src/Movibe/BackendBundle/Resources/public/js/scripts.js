    ...
    $(document).ready(function () {
        ...
        if ($('#calendar2').length) {
            $('#calendar2').fullCalendar({
                ...
                events: [{
                    ...
                    id: 999,
                    title: 'Les sorties de la semaine',
                    start: new Date(yyy, mmm,  8)
                }, {
                    id: 999,
                    title: 'Les sorties de la semaine',
                    start: new Date(yyy, mmm, 15)
                }, {
                    id: 999,
                    title: 'Les sorties de la semaine',
                    start: new Date(yyy, mmm, 22)
                }, {
                    title: 'Les sorties de la semaine',
                    start: new Date(yyy, mmm, 29)
                }]
            });
        }
        ...
        $(document).ready(function () {
            ...
            if ($('#table-2').length) {
                ...
                $('.paginate_active').addClass('btn btn-default');
                $('.paginate_active').attr('disabled',true);
...
/* Mis en commentaire car BUG sur évènement .change
        // ========================================================================
