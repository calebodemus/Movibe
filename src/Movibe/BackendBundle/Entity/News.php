...
class News
{
     ...
     * Set image
     *
     * @param \Movibe\BackendBundle\Entity\Image $image
     * @return News
     */
    public function setImage(\Movibe\BackendBundle\Entity\Image $image = null)
    {
        $this->image = $image;
     ...
     * Get image
     *
     * @return \Movibe\BackendBundle\Entity\Image 
     */
